//package ds.mesh.project.custom_view;
//
//
//
///**
// * Created by nasser on 12/2/17.
// */
//
...
//    public static final float SCALE_END_VALUE = 120.0f;
//    public static final float SCALE_START_ANGLE = 30.0f;
//    public static final int SCALE_DIVISIONS = 12;
//    public static final int SCALE_SUBDIVISIONS = 6;
//
...
//
//    public static final float[] RANGE_VALUES = {16.0f, 40.0f, 60.0f, 121.0f};
...
//    private float mSubdivisionAngle2;
//
...
//        final BitmapShader aluminiumTile = new BitmapShader(bitmap, Shader.TileMode.REPEAT, Shader.TileMode.REPEAT);
...
//        mNeedleRightPath.moveTo(x - mNeedleWidth, y);
...
//        paint.setColor(Color.parseColor("#FF9D27"));
//        return paint;
//    }
//
...
//        mSubdivisionAngle2 = (mScaleEndAngle - mScaleStartAngle) / 19;
//    }
//
//    @Override
...
//            final float y1 = mScaleRect.top +  0.05f;
//            final float y2 = y1 + 0.040f; // height of subdivision
//            final float y3 = y1 + 0.045f; // height of division
//            final float y4 = y1 + 0.042f; // height of sub-subdivision
//
//
//
//
...
//            if ((Math.abs(mod - 0) < 0.001) || (Math.abs(mod - mDivisionValue) < 0.001)) {
//                // Draw a division tick
//                Paint paintDiv = new Paint(Paint.ANTI_ALIAS_FLAG);
//                paintDiv.setColor(Color.parseColor("#6f6f6f"));
//                paintDiv.setStrokeWidth(0.01f);
//                canvas.drawLine(0.5f, y1, 0.5f, y3, paintDiv);
//                // Draw the text 0.15 away from the division tick
//                drawTextOnCanvasWithMagnifier(canvas, valueString(value), 0.5f, y3 + 0.045f, paint);
//            } else {
//                // Draw a subdivision tick
...
//
//                if (i%5 == 0) {
//                    Paint paintSubSubDiv = new Paint(Paint.ANTI_ALIAS_FLAG);
//                    paintSubSubDiv.setColor(paint.getColor());
//                    paintSubSubDiv.setStrokeWidth(0.009f);
//                    canvas.drawLine(0.5f, y1 + 0.003f, 0.5f, y4, paintSubSubDiv);
//                } else {
//                    Paint paintSubDiv = new Paint(Paint.ANTI_ALIAS_FLAG);
//                    paintSubDiv.setColor(paint.getColor());
//                    paintSubDiv.setStrokeWidth(0.008f);
//                    canvas.drawLine(0.5f, y1+ 0.010f, 0.5f, y2, paintSubDiv);
//                }
//
//            }
//
...
//
//
//    private void drawScale2(final Canvas canvas) {
//        canvas.save(Canvas.MATRIX_SAVE_FLAG);
//        // On canvas, North is 0 degrees, East is 90 degrees, South is 180 etc.
//        // We start the scale somewhere South-West so we need to first rotate the canvas.
//        canvas.rotate(mScaleRotation, 0.5f, 0.5f);
...
//            paintText.setColor(Color.parseColor("#dedede"));
//            paintText.setStyle(Paint.Style.STROKE);
//            paintText.setStrokeWidth(0.001f);
//            paintText.setTextSize(0.03f);
//            paintText.setTypeface(Typeface.SANS_SERIF);
//            paintText.setTextAlign(Paint.Align.CENTER);
//            paintText.setShadowLayer(0.005f, 0.002f, 0.002f, mTextShadowColor);
//
//            Paint paintDiv = new Paint(Paint.ANTI_ALIAS_FLAG);
//            paintDiv.setColor(Color.parseColor("#FF9D27"));
//            paintDiv.setStrokeWidth(0.01f);
//            canvas.drawLine(0.5f, y1 , 0.5f, y3, paintDiv);
//            // Draw the text 0.15 away from the division tick
//            if (i%2 == 0) {
//                drawTextOnCanvasWithMagnifier(canvas, valueString(i * 10), 0.5f, y3 + 0.045f, paintText);
//            }
//
//            // } else {
//            // Draw a subdivision tick
...
//
//
//            canvas.rotate(mSubdivisionAngle2, 0.5f, 0.5f);
//        }
//        canvas.restore();
//    }
//
...
//            canvas.drawCircle(0.5f, 0.5f, 0.035f, mNeedleScrewBorderPaint);
//
